...
class BuySellmidTerm(AbsBuySell):
    def BuySell(self,df : df) -> list:
        ...
        for mn in range(len(df.index)):
            ...
            level7mt = df["amb13"][mn] >=0.8 and df["amb15"][mn] >=0.8 and df["amb55"][mn] >=0.8
            level8mt = df["amb13"][mn] >=0.85 and df["amb14"][mn] >=0.82 and df["amb15"][mn] >=0.85 and df["amb55"][mn] >=0.65
            sellT2 = sellT1 or level5mh or level6mh or level126 or level7mt or level8mt
            ...
            level6b = df ["ww1"] [mn] <= 0.1  and  df ["ww7"] [mn] >= 0.5 and  df ["BUY2"] [mn] <= 0.1
            level8b = df ["ww6"] [mn] >=0.4 and df ["ww1"] [mn] <=0.6 and   df ["ambb5"] [mn] <= 0.55
            level88b = df ["ww6"] [mn] >=0.1 and df ["ww1"] [mn] <=0.5
